...
const Donations = () => {
  ...
  const handleExportSummaryPDF = async () => {
    ...
    // Show loading alert
    const closeLoading = showAlert({
      type: 'loading',
      title: 'Generating Summary PDF...',
      message: 'Please wait while we create your comprehensive donation summary report.',
      autoClose: false
    });
    ...
    try {
      ...
      if (result.success) {
        ...
        showAlert({
          type: 'celebration',
          title: 'Summary PDF Export Successful! 🎉',
          message: `Your donation summary report "${result.fileName}" has been downloaded successfully!`,
          autoClose: 5000
        });
      } else {
        ...
        showAlert({
          ...
          message: 'Failed to generate summary PDF report. Please try again or contact support if the issue persists.',
          autoClose: 8000
        });
      }
    } catch (error) {
      ...
      showAlert({
        type: 'urgent',
        title: 'Export Error',
        message: `An unexpected error occurred: ${error.message}. Please refresh the page and try again.`,
        autoClose: 8000
      });
    } finally {
  ...
  const handleExportSummaryExcel = async () => {
    ...
    showAlert({
      type: 'loading',
      title: 'Generating Summary Excel...',
      message: 'Please wait while we create your comprehensive donation summary spreadsheet.',
      autoClose: false
    });
    ...
    try {
      ...
      if (result.success) {
        ...
        showAlert({
          type: 'celebration',
          title: 'Summary Excel Export Successful! 📊',
          message: `Your donation summary spreadsheet "${result.fileName}" has been downloaded successfully!`,
          autoClose: 5000
        });
      } else {
        ...
        showAlert({
          ...
          message: 'Failed to generate summary Excel spreadsheet. Please try again or contact support if the issue persists.',
          autoClose: 8000
        });
      }
    } catch (error) {
