...
const EditFocusAreaModal = ({ isOpen, onClose, onUpdateFocusArea, focusArea }) => {
  ...
  // Populate form when focusArea changes
  useEffect(() => {
    if (focusArea) {
      setFormData({
        title: focusArea.title || '',
        description: focusArea.description || '',
        image: focusArea.image || '',
        location: focusArea.location || '',
        priority: focusArea.priority || 'medium'
      });
      setImagePreview(focusArea.image || '');
    }
  }, [focusArea]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await onUpdateFocusArea(updatedFocusArea);
      ...
      alert.error(
        '❌ Update Failed',
        'Something went wrong while updating the focus area. Please try again.',
        {
          animation: 'shake',
          sound: true,
          autoClose: true,
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '20px' }}>
          <h2 style={{ margin: 0, fontSize: '24px', fontWeight: 'bold' }}>Edit Focus Area</h2>
          <button
            onClick={handleClose}
            style={{
              background: 'none',
...
export default EditFocusAreaModal;
